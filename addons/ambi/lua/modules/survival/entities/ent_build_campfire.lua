...
ENT.Class       = 'survival_build_campfire'
ENT.Type	    = 'anim'

ENT.PrintName	= '[Build] Furnace'
ENT.Author		= 'Ambi'
...
ENT.Stats = {
    type = 'Entity',
    module = 'Survival',
    model = 'models/galaxy/rust/campfire.mdl',
    date = '17.07.2021 14:07:26'
}
...
if CLIENT then
    ...
    function ENT:DrawTranslucent()
        ...
        cam.Start3D2D( pos + Vector( 0, 0, 6 ), Angle( 0, rot, 90 ), 0.1 )
            draw.SimpleTextOutlined( 'Обновляем...', UI.SafeFont( '64 Nexa Script Light' ), 4, 0, C.AMBITION, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
        cam.End3D2D()
    end
...
function ENT:Initialize()
    ...
    self:SetNWString( 'Building', 'campfire' )
end
...
function ENT:UpdatingLoop()
    ...
    local col = self.col and C.AMB_GREEN or C.AMB_RED
    self:SetColor( col )
