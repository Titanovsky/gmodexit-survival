...
if SERVER then
    ...
    hook.Add("CalcVehicleView", "rustminicopter_calcview", function(veh, ply, view)
...
function ENT:Initialize()
    if SERVER then
        self:SetModel("models/vehicles/darky_m&bypolat/rust/minicopter.mdl")
        ...
        self.seatDriver:SetPos(self:GetPos() + Vector(8.5, 0, 17))
        self.seatDriver:SetAngles(self:GetAngles() + Angle(0, -90, 0))
        ...
        self.seatGunner:SetPos(self:GetPos() + Vector(42.5, 0, 11))
        self.seatGunner:SetAngles(self:GetAngles() + Angle(0, -90, 0))
...
if SERVER then
    ...
    function ENT:Use(ply)
        ...
        if not self.driver and hitpos:WithinAABox(Vector(0, -10, 60), Vector(25, 10, 10)) then
            ...
            net.WriteBool(true)
            net.Send(ply)
        elseif not self.gunner and hitpos:WithinAABox(Vector(33, -10, 38), Vector(55, 10, 10)) then
    ...
    function ENT:ProcessDamage()
        if self.driver then
            self.driver:ChatPrint(math.floor(self.health) .. " health remaining..")
        end
    ...
    local minicopterGibs = {"models/vehicles/darky_m&bypolat/rust/minicopter_gib0.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib1.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib2.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib3.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib4.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib5.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib6.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib7.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib8.mdl", "models/vehicles/darky_m&bypolat/rust/minicopter_gib9.mdl"}
    ...
    function ENT:CreateGibs()
        for _, v in pairs(minicopterGibs) do
            ...
            if IsValid(ent) then
                ...
                ent:SetModel(v)
                ent:SetMaterial("models/darky_m&bypolat/rust/minicopter/minicoptor prt 1")
                ...
                if v == "models/vehicles/darky_m&bypolat/rust/minicopter_gib1.mdl" then
