...
SWEP.Primary.ProjectileModel = "models/weapons/darky_m/rust/w_Machete.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("darky_rust.machete-attack"),
		["snd_delay"] = 0.25,
...
SWEP.SoundMats = {
	[MAT_DEFAULT]		= Sound("darky_rust.machete-strike"),
	[MAT_WOOD]			= Sound("darky_rust.machete-strike-muted"),
	[MAT_ALIENFLESH]	= Sound("darky_rust.machete-strike-muted"),
	[MAT_BLOODYFLESH]	= Sound("darky_rust.machete-strike-muted"),
	[MAT_FLESH]			= Sound("darky_rust.machete-strike-muted"),
}
