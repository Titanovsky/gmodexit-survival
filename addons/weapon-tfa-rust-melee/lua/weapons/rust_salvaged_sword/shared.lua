...
SWEP.Author = "Darky"
SWEP.PrintName = "Salvaged Sword"

SWEP.ViewModel = "models/weapons/darky_m/rust/c_salvaged_sword.mdl"
SWEP.UseHands = true
SWEP.WorldModel = "models/weapons/darky_m/rust/w_salvaged_sword.mdl"
SWEP.HoldType = "knife"
...
SWEP.Primary.ProjectileModel = "models/weapons/darky_m/rust/w_salvaged_sword.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("darky_rust.sword-attack"),
		["snd_delay"] = 0.25,
...
SWEP.SoundMats = {
	[MAT_DEFAULT]		= Sound("darky_rust.sword-strike"),
	[MAT_WOOD]			= Sound("darky_rust.sword-strike-muted"),
	[MAT_ALIENFLESH]	= Sound("darky_rust.sword-strike-muted"),
	[MAT_BLOODYFLESH]	= Sound("darky_rust.sword-strike-muted"),
	[MAT_FLESH]			= Sound("darky_rust.sword-strike-muted"),
}
