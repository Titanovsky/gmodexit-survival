...
SWEP.Author = "Darky"
SWEP.PrintName = "Salvaged Cleaver"
...
SWEP.Primary.ProjectileModel = "models/weapons/darky_m/rust/w_salvaged_Cleaver.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("darky_rust.2handed-cleaver-attack"),
		["snd_delay"] = 0.5,
...
SWEP.SoundMats = {
	[MAT_DEFAULT]		= Sound("darky_rust.2handed-cleaver-strike"),
