...
SWEP.ViewModel = "models/weapons/darky_m/rust/c_boneclub.mdl"
SWEP.UseHands = true
SWEP.WorldModel = "models/weapons/darky_m/rust/w_boneclub.mdl"
SWEP.HoldType = "knife"
...
SWEP.Primary.ProjectileModel = "models/weapons/darky_m/rust/w_boneclub.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("darky_rust.bone-club-attack"),
		["snd_delay"] = 0.05,
