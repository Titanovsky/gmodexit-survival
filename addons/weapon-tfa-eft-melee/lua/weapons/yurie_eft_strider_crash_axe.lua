...
SWEP.PrintName = "Crash Axe"
SWEP.ViewModel = "models/yurie/eft/weapons/strider_crash_axe.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/strider_crash_axe.mdl"
SWEP.HoldType = "melee"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_strider_crash_axe")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_strider_crash_axe", "yurie/eft/icons/death/weapon_strider_crash_axe", Color(255, 80, 0, 255))
end
