...
SWEP.PrintName = "6h5 Bayonet"
SWEP.ViewModel = "models/yurie/eft/weapons/izhmash_6x5.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/izhmash_6x5.mdl"
SWEP.HoldType = "melee"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_izhmash_6x5")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_izhmash_6x5", "yurie/eft/icons/death/weapon_izhmash_6x5", Color(255, 80, 0, 255))
end
