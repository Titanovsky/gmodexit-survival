...
SWEP.PrintName = "MPL-50 entrenching tool"
SWEP.ViewModel = "models/yurie/eft/weapons/voentorg_mpl-40.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/voentorg_mpl-40.mdl"
SWEP.HoldType = "melee"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_voentorg_mpl-50")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_voentorg_mpl-50", "yurie/eft/icons/death/weapon_voentorg_mpl-50", Color(255, 80, 0, 255))
end
