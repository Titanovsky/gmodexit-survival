...
SWEP.PrintName = "Bars A-2607- Damascus"
SWEP.ViewModel = "models/yurie/eft/weapons/bars_a-2607_damask.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/bars_a-2607_damask.mdl"
SWEP.HoldType = "melee"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_bars_a-2607_damask")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_bars_a-2607_damask", "yurie/eft/icons/death/weapon_bars_a-2607_damask", Color(255, 80, 0, 255))
end
