...
SWEP.PrintName = "Kiba Arms Tactical Tomahawk"
SWEP.ViewModel = "models/yurie/eft/weapons/kiba_arms_axe.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/kiba_arms_axe.mdl"
SWEP.HoldType = "melee"
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_kiba_arms_axe")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_kiba_arms_axe", "yurie/eft/icons/death/weapon_kiba_arms_axe", Color(255, 80, 0, 255))
end
