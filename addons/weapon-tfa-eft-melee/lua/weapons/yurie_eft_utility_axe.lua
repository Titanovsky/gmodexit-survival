...
SWEP.ViewModel = "models/yurie/eft/weapons/utility_axe.mdl"
SWEP.ViewModelFOV = 65
SWEP.UseHands = true
SWEP.WorldModel = "models/yurie/eft/weapons/world/utility_axe.mdl"
SWEP.HoldType = "melee"
...
SWEP.Secondary.Attacks = {
	{
		...
		["dir"] = Vector(-5, 57.75, 5), -- Trace arc cast
...
SWEP.InspectAng = Vector(30, 50, 50)

if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("yurie/eft/icons/hud/weapon_utility_axe")
end
if killicon and killicon.Add then
	killicon.Add("yurie_eft_utility_axe", "yurie/eft/icons/death/weapon_utility_axe", Color(255, 80, 0, 255))
end
