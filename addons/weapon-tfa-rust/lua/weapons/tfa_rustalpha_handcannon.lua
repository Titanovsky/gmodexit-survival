...
SWEP.PrintName			= "HandCannon"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Ammo = "yurie_rustalpha_handmade_shell" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.Primary.KickHorizontal = .5 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.IronAccuracy = .12 -- Ironsight accuracy, should be the same for shotguns
