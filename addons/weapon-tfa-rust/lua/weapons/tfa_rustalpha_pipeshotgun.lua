...
SWEP.PrintName			= "Pipe Shotgun"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("YURIE_RUSTALPHA.WATERPIPE.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickHorizontal = .52 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/yurie_rustalpha/c-vm-pipeshotgun.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/yurie_rustalpha/wm-pipeshotgun.mdl" -- Weapon world model path
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.WATERPIPE.Reload")}
	},
}
--[[RENDER TARGET]]--
