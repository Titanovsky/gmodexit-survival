...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("YURIE_RUSTALPHA.9MM.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("YURIE_RUSTALPHA.9MM.2") -- This is the sound of the weapon, when silenced.
...
--Recoil Related
SWEP.Primary.KickUp = .48 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .32 -- This is the maximum downwards recoil (skeet)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/yurie_rustalpha/c-vm-vertec.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 54		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(1.25, 0, 1.5)
SWEP.VMAng = Vector(1, 4, 0)
SWEP.VMPos_Additive = false --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, run, whateverelse
SWEP.CenteredPos = nil --The viewmodel positional offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.CenteredAng = nil --The viewmodel angular offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.Bodygroups_V = nil
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/yurie_rustalpha/wm-vertec.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(4.75, -7.5, 1.5)
SWEP.RunSightsAng = Vector(-9.5, 17, 0)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.145, -8, 3.975)
SWEP.IronSightsAng = Vector(-0.415, -0.025, 0)

SWEP.Secondary.IronFOV_Holosight = 75
SWEP.IronSightsPos_Holosight = Vector(-4.151, -10, 3.1)
SWEP.IronSightsAng_Holosight = Vector(-3.05, -0.018, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackAngle = Angle(6, 0, 0)
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.9MM.Draw")}
	},
	[ACT_VM_RELOAD] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.9MM.Reload")}
	},
}
--[[RENDER TARGET]]--
...
SWEP.VElements = {
	["holo_sight"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.slide", rel = "", pos = Vector(-0.025, 0, -0.276), angle = Angle(0, -90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["silencer"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.barrel", rel = "", pos = Vector(-0.315, 0, 4.074), angle = Angle(90, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}

SWEP.WElements = {
	["holo_sight"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.slide", rel = "", pos = Vector(-0.025, 0, -0.276), angle = Angle(0, -90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {[1] = 1} },
	["silencer"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.barrel", rel = "", pos = Vector(-0.315, 0, 4.074), angle = Angle(90, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}
