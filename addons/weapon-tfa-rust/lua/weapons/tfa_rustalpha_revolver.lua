...
SWEP.Primary.RPM = 60 / 0.2 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp = .64 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .48 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .14 -- This is the maximum sideways recoil (no real term)
