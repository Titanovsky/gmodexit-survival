...
SWEP.PrintName			= "MP5A4"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("YURIE_RUSTALPHA.MP5.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("YURIE_RUSTALPHA.MP5.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 60 / 0.115 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp = .28 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .16 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .28 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/yurie_rustalpha/c-vm-mp5.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 54		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0, -2.5, -1.5)
SWEP.VMAng = Vector(5, 4.5, 0)
SWEP.VMPos_Additive = false --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, run, whateverelse
SWEP.CenteredPos = nil --The viewmodel positional offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.CenteredAng = nil --The viewmodel angular offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.Bodygroups_V = nil
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/yurie_rustalpha/wm-mp5.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(8, -5.5, 4.5)
SWEP.RunSightsAng = Vector(-15, 45, 2.5)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.975, -4, 2.099)
SWEP.IronSightsAng = Vector(1.019, -0.004, 0)

SWEP.Secondary.IronFOV_Holosight = 70
SWEP.IronSightsPos_Holosight = Vector(-4.975, -4, 1.65)
SWEP.IronSightsAng_Holosight = Vector(0.71, 0.045, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackBoneMods = {
	["ValveBiped.bolt"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -3.725), angle = Angle(0, 0, 0) },
	["ValveBiped.bullet"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.7, -0.85), angle = Angle(0, 0, 3.5) }
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.MP5.Draw")}
	},
	[ACT_VM_RELOAD] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.MP5.Reload")}
	},
}
--[[RENDER TARGET]]--
...
SWEP.VElements = {
	["holo_sight"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.mp5_rootbone", rel = "", pos = Vector(-5.25, -0.25, 3.75), angle = Angle(-90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["silencer"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.mp5_rootbone", rel = "", pos = Vector(-4.25, -0.25, 17.649), angle = Angle(90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}

SWEP.WElements = {
	["holo_sight"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.mp5_rootbone", rel = "", pos = Vector(-5.25, -0.25, 3.75), angle = Angle(-90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {[1] = 1} },
	["silencer"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.mp5_rootbone", rel = "", pos = Vector(-4.25, -0.25, 17.649), angle = Angle(90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}
