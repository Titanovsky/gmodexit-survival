...
SWEP.PrintName			= "M4"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("YURIE_RUSTALPHA.M4.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("YURIE_RUSTALPHA.M4.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 60 / 0.125 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.KickHorizontal = .24 -- This is the maximum sideways recoil (no real term)
...
--Range Related
SWEP.Primary.Range = 0.14 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/yurie_rustalpha/c-vm-m4.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/yurie_rustalpha/wm-m4.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(4, -8, -0.5)
SWEP.RunSightsAng = Vector(0, 60, -4)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.902, -4, 0.62)
SWEP.IronSightsAng = Vector(0.38, 0.085, 0)

SWEP.IronSightsPos_Holosight = Vector(-3.902, -4, 0.38)
SWEP.IronSightsAng_Holosight = Vector(-0.694, 0.13, 0)
--[[INSPECTION]]--
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.M4.Draw")}
	},
	[ACT_VM_RELOAD] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.M4.Reload")}
	},
}
--[[RENDER TARGET]]--
...
SWEP.VElements = {
	["holo_sight"] = {type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.m4_rootbone", rel = "", pos = Vector(-4.95, 0, 3.5), angle = Angle(-90, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
	["silencer"] = {type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.m4_rootbone", rel = "", pos = Vector(-3.9, 0, 18), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
}

SWEP.WElements = {
	["holo_sight"] = {type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.m4_rootbone", rel = "", pos = Vector(-4.95, 0, 3.5), angle = Angle(-90, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1}, active = false},
	["silencer"] = {type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.m4_rootbone", rel = "", pos = Vector(-3.9, 0, 18), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false},
}
...
SWEP.AttachmentTableOverride = {
	["rustalpha_holo_sight"] = {
		["ViewModelCullDistance"] = 12
	}
}