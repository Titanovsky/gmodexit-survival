...
SWEP.Category = 'Выживашка'
SWEP.Spawnable = true

SWEP.Author = 'Ambition' -- base: YuRaNnNzZZ
SWEP.PrintName = 'Кирка: Медная'

SWEP.Type = 'Melee Weapon'
SWEP.Type_Displayed = 'Инструмент'

SWEP.ViewModel = "models/weapons/yurie_rustalpha/c-vm-pickaxe-copper.mdl"
SWEP.UseHands = true
