...
SWEP.PrintName = "Bow" -- Weapon name (Shown on HUD) 
...
SWEP.Primary.Ammo = "yurie_rustalpha_arrow" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.  
