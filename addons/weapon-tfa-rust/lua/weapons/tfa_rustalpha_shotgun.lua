...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("YURIE_RUSTALPHA.FP6.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("YURIE_RUSTALPHA.FP6.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 60 / 1.5 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp = .8 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .64 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .32 -- This is the maximum sideways recoil (no real term)
...
--Range Related
SWEP.Primary.Range = 0.03 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 1 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 4 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.5 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchRecoilMultiplier = 0.8
--Movespeed
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/yurie_rustalpha/c-vm-fp6.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 54		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(2, -2, -4)
SWEP.VMAng = Vector(4, 2, 0)
SWEP.VMPos_Additive = false --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, run, whateverelse
SWEP.CenteredPos = nil --The viewmodel positional offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.CenteredAng = nil --The viewmodel angular offset, used for centering.  Leave nil to autodetect using ironsights.
SWEP.Bodygroups_V = nil
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/yurie_rustalpha/wm-fp6.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6, -16, 1.75)
SWEP.RunSightsAng = Vector(-16, 65, 0)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.811, -8, 0.98)
SWEP.IronSightsAng = Vector(-0.66, -0.096, 0)

SWEP.Secondary.IronFOV_Holosight = 75
SWEP.IronSightsPos_Holosight = Vector(-4.817, -8, -0.6)
SWEP.IronSightsAng_Holosight = Vector(0.108, -0.805, 0)
--[[INSPECTION]]--
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.FP6.Draw")}
	},
	[ACT_VM_RELOAD] = {
		{time = 0, type = "sound", value = Sound("YURIE_RUSTALPHA.FP6.Reload")}
	},
}
--[[RENDER TARGET]]--
...
SWEP.VElements = {
	["holo_sight"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-holosight.mdl", bone = "ValveBiped.FP6_base", rel = "", pos = Vector(-5.85, 0, 6.4), angle = Angle(-90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["silencer"] = { type = "Model", model = "models/weapons/yurie_rustalpha/vm-mod-silencer.mdl", bone = "ValveBiped.FP6_base", rel = "", pos = Vector(-4.55, 0.1, 28.4), angle = Angle(90, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}

SWEP.WElements = table.Copy(SWEP.VElements)
